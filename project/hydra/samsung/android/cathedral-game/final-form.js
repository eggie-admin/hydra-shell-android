/* KAI9000_FINAL_FORM_PET_V1
   In-app LuHm pet/cockpit. No eval, no shell, no network, no privilege bridge. */
(()=>{'use strict';
...
const panel=document.createElement('section');panel.id='luhmPetPanel';panel.hidden=true;panel.innerHTML=`
  <div class="ff-head"><strong>LUM // FINAL FORM</strong><button id="ffMin" type="button">—</button><button id="ffClose" type="button">×</button></div>
  <div class="ff-tabs"><button class="ff-tab active" data-tab="pet" type="button">PET</button><button class="ff-tab" data-tab="system" type="button">SYSTEM</button><button class="ff-tab" data-tab="boss" type="button">BOSS</button></div>
  <div class="ff-body">
    ...
    <div class="ff-pane" data-pane="system" hidden><div class="ff-kv"><span>PACKAGE</span><b>art.eggiebagelface.luhmos</b><span>BUILD</span><b>1.0.2 / 102</b><span>BASE GAME</span><b class="ff-good">BUNDLED</b><span>LOCAL SAVE</span><b class="ff-good">ON-DEVICE</b><span>TERMUX</span><b class="ff-amber">OPTIONAL</b><span>VNC</span><b>:5901 optional</b><span>WEBSOCKET</span><b>:6080 optional</b><span>SSH</span><b>:8022 optional</b><span>OLLAMA</span><b>:11434 optional</b><span>REBOOT PROOF</span><b class="ff-amber">PENDING</b></div><div class="ff-muted">This panel reports build doctrine, not live socket truth. The APK never fakes GREEN runtime status and never executes shell commands.</div></div>
...
bubble.addEventListener('click',e=>{if(bubble.dataset.dragged==='1'){bubble.dataset.dragged='0';return}panel.hidden=false;bubble.hidden=true;setTab('pet')});
