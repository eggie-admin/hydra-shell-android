...
def main() -> int:
    ...
    bound_files = {
        ...
        "enterprise_distribution": game / "distribution/enterprise-distribution.json",
        "enterprise_runtime": game / "enterprise-distribution.js",
        "enterprise_runtime_test": game / "tests/enterprise-distribution.test.mjs",
        "enterprise_native_patch": game / "tools/patch-enterprise-android.py",
        "release_manifest_builder": game / "tools/make-release-manifest.py",
        "local_backend_harness": game / "python/src/luhm_core/local_harness.py",
