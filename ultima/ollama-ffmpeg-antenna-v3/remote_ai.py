...
def _call_responses_api(provider: str, message: str, model: str | None, *, profile: str = "deep", instructions: str | None = None, previous_response_id: str | None = None) -> dict[str, Any]:
